...
:root{
	...
	--background-color-sidebar-mobile: <?php echo ($layout === 'night' ? 'linear-gradient(0deg, rgba(3,12,22,1) 20%, rgba(10,35,66,1) 100%)' : 'rgba(250,250,250,1)'); ?>;
	...
	--border-title: <?php echo ($layout === 'night' ? '#cbba79' : '#444'); ?>;
