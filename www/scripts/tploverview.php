...
$e = $db->query('SELECT id, title, word, owner, LENGTH(tpl) size, UNIX_TIMESTAMP(last_update) updated, update_user FROM templates WHERE del="0" '.$sort_order, __FILE__, __LINE__);
$list = array();
$totalsize = 0;
