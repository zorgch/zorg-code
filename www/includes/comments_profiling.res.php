...
$prof->startTimer( "comments.res.php: all requires" );
...
$prof->stopTimer( "comments.res.php: all requires" );



// tpl resource -------------------------------------------------------------
$prof->startTimer( "comments.res.php: fnc get_tpl_timestamp" );
...
$prof->stopTimer( "comments.res.php: fnc get_tpl_timestamp" );

// tpl resource
$prof->startTimer( "comments.res.php: fnc comm_get_secure" );
function smartyresource_comments_get_secure($tpl_name, &$smarty_obj) {
  // sicherheit des templates $tpl_name überprüfen
  return true;
}
$prof->stopTimer( "comments.res.php: fnc comm_get_secure" );


// tpl resource
$prof->startTimer( "comments.res.php: fnc comm_get_trusted" );
function smartyresource_comments_get_trusted($tpl_name, &$smarty_obj) {
  // nicht verwendet; funktion muss aber existieren
}
$prof->stopTimer( "comments.res.php: fnc comm_get_trusted" );


$prof->startTimer( "comments.res.php: fnc comm_get_thread" );
...
$prof->stopTimer( "comments.res.php: fnc comm_get_thread" );
...
$prof->startTimer( "comments.res.php: fnc comm_get_tpl" );
...
$prof->stopTimer( "comments.res.php: fnc comm_get_tpl" );


$prof->startTimer( "comments.res.php: fnc comm_get_nav" );
...
$prof->stopTimer( "comments.res.php: fnc comm_get_nav" );


$prof->startTimer( "comments.res.php: fnc comm_get_commenttree" );
...
$prof->stopTimer( "comments.res.php: fnc comm_get_commenttree" );


$prof->startTimer( "comments.res.php: fnc comm_get_childpost" );
...
$prof->stopTimer( "comments.res.php: fnc comm_get_childpost" );
