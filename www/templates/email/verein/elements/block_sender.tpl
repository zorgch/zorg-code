{if $smarty.post.topic == 'president'}{assign var=sender value=117}{elseif $smarty.post.topic == 'actuary'}{assign var=sender value=11}{elseif $smarty.post.topic == 'treasurer'}{assign var=sender value=52}{/if}
