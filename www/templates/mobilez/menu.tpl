...
{if $user->id > 0}
{* Menu left *}
{*<div data-ui-role="panel" data-display="push" data-theme="a" id="{assign var='menuId' value='menu'}{$menuId}">
...
{* Menu right *}
<div data-ui-role="popup" id="{assign var='menuRight' value='menuProfile'}{$menuRight}" data-theme="{$layout}">
	<ul data-ui-role="listview">
		<li><a href="#popupLogout" data-rel="popup">Abmelden</a></li>
		<li data-ui-role="list-divider">Profil Details:</li>
		<li><a href="#">Anzeigen</a></li>
		<li><a href="#">Meine Bilder</a></li>
	</ul>
</div>
<div data-ui-role="popup" id="popupBugtracker" data-theme="{$layout}" class="ui-content" data-dismissible="true">
    <a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-left">Close</a>
	...
	<form id="formReportBug" data-ajax="true" method="post" action="ajax_post_bug.php">
		<input type="hidden" data-ui-role="hidden" name="from_mobile" id="from_mobile" value="{$user_mobile}">
		<label for="title" class="ui-hidden-accessible">Titel:</label>
		<input type="text" data-ui-role="text" name="title" id="title" placeholder="Titel" data-theme="a">
		...
		<button type="button" name="buttonReportBug" id="buttonReportBug" value="Eintragen" class="ui-btn ui-corner-all ui-nodisc-icon ui-btn-b ui-widget-icon-floatend ui-icon-mail">Melden</button>
		<a href="../bugtracker.php" rel="external" data-ajax="false" target="_blank" data-role="button" name="buttonBugtrackerOpen" id="buttonBugtrackerOpen" class="ui-btn ui-corner-all ui-nodisc-icon ui-btn-b ui-widget-icon-floatend ui-icon-arrow-r">Bugtracker &ouml;ffnen</a>
	</form>
</div>
<div data-ui-role="popup" id="popupLogout" data-theme="{$layout}" class="ui-content" data-dismissible="false">
    <a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-left">Close</a>
	<h3>Willst Du Dich wirklich aus zorg.ch abmelden?</h3>
	<form data-ajax="true" method="post" action="{$smarty.server.SCRIPT_NAME}">
		<a data-ui-role="button" href="#" data-rel="back" data-inline="true" class="ui-btn ui-mini ui-corner-all ui-nodisc-icon ui-btn-b ui-widget-icon-floatbeginning ui-icon-delete">Oops nei doch nö</a>
		<button type="submit" id="logout" name="logout" value="logout" data-inline="true" class="ui-btn ui-mini ui-corner-all ui-nodisc-icon ui-btn-b ui-widget-icon-floatbeginning ui-icon-thumbs-up">Jawohl!</button>
	</form>
</div>
<script>{literal}
