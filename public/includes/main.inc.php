...
//require_once INCLUDES_DIR.'mysql.inc.php'; --> already included via config.inc.php
//require_once INCLUDES_DIR.'usersystem.inc.php'; --> already included via config.inc.php
//require_once INCLUDES_DIR.'util.inc.php'; --> already included via config.inc.php
