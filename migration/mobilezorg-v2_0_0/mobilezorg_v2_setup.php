 ...
 * FILE INCLUDES
 */
if (!require_once rtrim(dirname(__FILE__).'/../../www/mobilezorg-v2/config.php','/\\')) die('ERROR: Configurations could NOT be loaded!');
if (!require_once rtrim(dirname(__FILE__).'/../../www/includes/usersystem.inc.php','/\\')) die('ERROR: Configurations could NOT be loaded!');
